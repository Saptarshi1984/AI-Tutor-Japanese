...
const MobileContainer = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative mx-auto flex w-full max-w-[26rem] flex-col min-h-[830px] max-h-[930px] overflow-hidden bg-gray-950 shadow-xl md:!border md:!border-gray-700"
